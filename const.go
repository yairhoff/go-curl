...
const (
	...
	HTTP_VERSION_2_0  = C.CURL_HTTP_VERSION_2_0
	HTTP_VERSION_2TLS  = C.CURL_HTTP_VERSION_2TLS
	HTTP_VERSION_2_PRIOR_KNOWLEDGE  = C.CURL_HTTP_VERSION_2_PRIOR_KNOWLEDGE
	HTTP_VERSION_3  = C.CURL_HTTP_VERSION_3
	HTTP_VERSION_3ONLY = C.CURL_HTTP_VERSION_3ONLY
)
...
const (
	...
	SSLVERSION_TLSv1_0 = C.CURL_SSLVERSION_TLSv1_0 /* TLSv1.0 (Added in 7.34.0) */

	SSLVERSION_TLSv1_1 = C.CURL_SSLVERSION_TLSv1_1 /* TLSv1.1 (Added in 7.34.0) */

	SSLVERSION_TLSv1_2 = C.CURL_SSLVERSION_TLSv1_2 /* TLSv1.2 (Added in 7.34.0) */

	SSLVERSION_TLSv1_3 = C.CURL_SSLVERSION_TLSv1_3 /* TLSv1.3 (Added in 7.52.0) */
)
